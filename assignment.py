...
class Model:
    ...
    def call(self, inputs):
        ...
        el = np.exp(l)
        sum_el = np.sum(el, 1)
        sum_el = sum_el.reshape(sum_el.shape[0], 1)  
        probabilities = el / sum_el 
...
def main():
    ...
    train_inputs, train_labels = \
        get_data('MNIST_data/train-images-idx3-ubyte.gz', 'MNIST_data/train-labels-idx1-ubyte.gz', trainset)
    testset = 10000
    test_inputs, test_labels = \
        get_data('MNIST_data/t10k-images-idx3-ubyte.gz', 'MNIST_data/t10k-labels-idx1-ubyte.gz', testset)
